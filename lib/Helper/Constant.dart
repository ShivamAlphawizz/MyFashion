final String appName = 'Jewel';

final String packageName = 'com.myfashn.user';
final String androidLink = 'https://play.google.com/store/apps/details?id=';

final String iosPackage = 'com.myfashn.user';
...
final String baseUrl = 'https://developmentalphawizz.com/jewel/app/v1/api/';
