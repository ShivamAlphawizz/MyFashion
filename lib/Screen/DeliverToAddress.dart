...
class DeliveryAddress extends StatefulWidget {
  ...
  const DeliveryAddress({Key? key, this.update, this.index}) : super(key: key);
...
class StateAddress extends State<DeliveryAddress> with TickerProviderStateMixin {
  String? name,
      mobile,
      city,
      area,
        ...
        Form(
            ...
            child: Column(
              children: [
                ...
                saveButton(getTranslated(context, 'SAVE_LBL')!, ()async{
                  Navigator.pop(context,{
                    "name":nameC!.text,
                    "mobile":mobileC!.text,
                    "address":addressC!.text,
