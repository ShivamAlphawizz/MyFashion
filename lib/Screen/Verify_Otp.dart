...
class _MobileOTPState extends State<VerifyOtp> with TickerProviderStateMixin {
  ...
  Future<void> getLoginUser() async {
    ...
    print("checking data here ${getdata}");
    print("ok final answer is here ${getdata['message']}");
    ...
    if (!error) {
      ...
      prefs.setString('user_type', userType.toString());
      ...
      print("ooooooo ${userType}");
      settingProvider.saveUserDetail(id!, username, email, mobile, city, area,userType,
...
String? token;
  ...
  Widget build(BuildContext context) {
    print("checking otp here ${widget.otp}");
    return Scaffold(
