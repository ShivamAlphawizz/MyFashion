...
class _LoginPageState extends State<Login> with TickerProviderStateMixin {
  ...
  String? token,countrycode;
  getFcmToken(){
    FirebaseMessaging.instance.getToken().then((value) {
       token = value;
       print("ok checking here ${token}");
    });
    print("mmmmmmmmmmmm ${token}");
  }
      ...
      Provider.of<SettingProvider>(context, listen: false);
        ...
        if (error!) {
          ...
          // setSnackbar(otp.toString());
           ...
           settingsProvider.setPrefrence(MOBILE, mobile.toString());
           settingsProvider.setPrefrence(COUNTRY_CODE, countrycode.toString());
